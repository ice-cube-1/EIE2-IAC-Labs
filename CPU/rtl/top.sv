...
decode decode (
    ...
    .rd1_e(rd1_e), .rd2_e(rd2_e), .pc_e(pc_e), .imm_ext_e(imm_ext_e), .pc_plus_4_e(pc_plus_4_e), .rd_e(rd_e), .control_bus_e(control_bus_e), .rs2_e(rs2_e), .rs1_e(rs1_e), .trigger(trigger)
);
execute execute (
